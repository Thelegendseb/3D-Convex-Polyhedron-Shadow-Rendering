Public Class GrahamScan
    Public Shared Function GetCovexHull(Points As List(Of Point)) As List(Of Point)
        ...
        ' // Algorithm is modelled from https://www.geeksforgeeks.org/convex-hull-set-2-graham-scan/
    ...
    Private Shared Sub RunAlgorithm(ByRef Points As List(Of Point), HullPoints As List(Of Point))
        ...
        If Points.Count > 0 Then
            ...
            Else
                ...
                Dim Cross As Double = CrossProduct_Z(dir1, dir2)
    ...
    End Sub
    '========================================
    Private Shared Function CrossProduct_Z(A As Point, B As Point) As Double
